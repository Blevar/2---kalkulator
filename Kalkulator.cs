...
namespace _2___kalkulator
{
    internal class Kalkulator : INotifyPropertyChanged
    {
        ...
        internal void WykonajDziałanie()
        {
            ...
            if (operacja == "+") Wynik = (operandLewy + operandPrawy).ToString();
            if (operacja == "-") Wynik = (operandLewy - operandPrawy).ToString();
            if (operacja == "/") Wynik = (operandLewy / operandPrawy).ToString();
            if (operacja == "*") Wynik = (operandLewy * operandPrawy).ToString();
            if (operacja == "^") Wynik = Math.Pow((double)operandLewy, (double)operandPrawy).ToString();
            if (operacja == "mod") Wynik = (operandLewy % operandPrawy).ToString();
